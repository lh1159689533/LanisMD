...
> **日期**: 2026-03-27
> **目标**: 定义 MyTypora 的完整用户体验设计规范，涵盖设计原则、信息架构、组件设计、交互规范、主题系统和响应式适配，可直接指导开发实现
...
MyTypora 的设计哲学围绕 **「沉浸式写作」** 这一核心理念展开，所有设计决策服务于让用户专注于内容创作这一目标。
...
MyTypora 的核心 WYSIWYG 交互：当前正在编辑的段落显示 Markdown 标记，其他段落显示渲染结果。
...
│                                  │
│  📄 readme.md                    │
│    ...使用 **MyTypora**...      │  ← 匹配文本上下文，关键字高亮
│    L12: 下载并安装 MyTypora     │  ← 行号 + 匹配行
│                                  │
│  📄 api.md                       │
│    ...API **文档**...            │
│    L5: 查看 API 文档            │
